...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2975}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.4169}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.4169}}@{}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.5646}}@{}}
...
\item
  ...
  \caption{Ketentuan Penulisan Tahun
  Publikasi}\label{tbl-formattahundafpus}\tabularnewline
  \toprule\noalign{}
  \begin{minipage}[b]{\linewidth}\raggedright
  Rujukan
  \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
  ...
  \bottomrule\noalign{}
  \endlastfoot
  Buku & Tuliskan tahun \emph{copyright} (dapat dilihat di halaman
  identitas buku) & (2022) \\
  Artikel jurnal ilmiah & Tuliskan tahun volume jurnal tersebut
  diterbitkan & (2018) \\
  Artikel daring (koran, majalan, blog) & Gunakan tanggal pembaharuan
  terakhir (\emph{last updated}) dari tulisan yang dikutip (jika
  dicantumkan) & (2023, 8 September) \\
  Artikel majalah cetak & Gunakan bulan terbitan majalah & (2017,
  Mei) \\
  Artikel jurnal ilmiah yang masih dalam proses penerbitan & Tuliskan
  (\emph{in press}) & (\emph{in press}) \\
  Artikel daring yang cenderung berubah dari waktu ke waktu & Tuliskan
  tanggal pengutipan setelah judul, sebelum URL. Tuliskan keterangan
  ''Dikutip pada'' diikuti dengan bulan, tanggal dan tahun. &
  Worldometer. (n.d.). World population clock. Dikutip pada 20 Oktober,
  2020, dari \url{https://www.worldometers.info/world-population/} \\
  \end{longtable}
\item
  Judul publikasi
  ...
  \begin{longtable}[]{@{}
    >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2575}}
    >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.5322}}
    >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2060}}@{}}
...
\item
  ...
  \begin{longtable}[]{@{}
    ...
    >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3995}}@{}}
...
\bibitem[\citeproctext]{ref-Bazeley2013}
...
\bibitem[\citeproctext]{ref-Knight2008}
...
\bibitem[\citeproctext]{ref-Locke2010}
...
\bibitem[\citeproctext]{ref-Sugiyono2018}
